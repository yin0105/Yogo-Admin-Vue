<template>
  ...
  <div class="flex flex-wrap">
    ...
    <div class="flex--25 mr10-md min-h-14" v-if="inputPeriodType === 'day' || inputPeriodType === 'custom'">
      <label>{{ $t('global.Date') }}</label>
      <datepicker v-model="inputDate" :monday-first="true"></datepicker>
    </div>


    <div class="flex--25" v-if="inputPeriodType === 'custom'">
...
<script>
  ...
  export default {
    ...
    name: 'reportperiodselectorsection',
    data() {
      return {
