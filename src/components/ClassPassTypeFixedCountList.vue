  ...
  <div>
    <md-table v-model="classPassTypes" :md-sort.sync="tableSortField"
      ...
      <md-table-row slot="md-table-row" slot-scope="{ item }" md-selectable="single">
        ...
        <md-table-cell :md-label="$t('global.ClassPassFixedNumber')" md-sort-by="name">{{ item.name }}</md-table-cell>
        <md-table-cell :md-label="$t('global.Classes_NumberOf')" md-sort-by="number_of_classes" md-numeric>{{
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        tableSortField: 'number_of_classes',
        tableSortOrder: 'asc',
      }
    },
    methods: {
